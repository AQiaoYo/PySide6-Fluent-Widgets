...
class TextInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            widget=lineEdit,
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/line_edit/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/widgets/line_edit/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=SpinBox(self),
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/spin_box/demo.py'
        )
