...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/state_tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            w,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/info_bar/demo.py'
        )
        ...
        card = self.addExampleCard(
            ...
            bar,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/progress_bar/demo.py',
        )
