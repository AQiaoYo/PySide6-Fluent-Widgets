...
class DialogInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_box/dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_box/message_dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_box/custom_message_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_box/color_dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/flyout/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.teachingButton,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/teaching_tip/demo.py'
        )
