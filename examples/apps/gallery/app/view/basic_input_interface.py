...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/widgets/button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/check_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            comboBox,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/combo_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            radioWidget,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/radio_button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            slider,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/slider/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.switchButton,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/switch_button/demo.py'
        )
