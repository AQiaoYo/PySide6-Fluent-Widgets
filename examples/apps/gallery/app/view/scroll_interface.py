...
class ScrollInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        card = self.addExampleCard(
            ...
            w,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/scroll_area/demo.py',
        )
        ...
        card = self.addExampleCard(
            self.tr('Pips pager'),
            pager,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/widgets/pips_pager/demo.py',
        )
