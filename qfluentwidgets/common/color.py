# coding: utf-8
"""Fluent Design 主题颜色与系统颜色工具模块

提供 Fluent 设计规范下的主题色板与系统强调色获取功能，以及颜色混合、透明度调整等常用工具函数，用于在自定义控件和界面绘制时统一应用 Fluent 色彩体系。支持根据系统亮暗模式自动适配颜色，并包含对 QColor 的辅助操作方法以简化主题色管理
"""
